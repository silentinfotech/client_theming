...
#ifndef SILENT_DRIVE_THEME_H
#define SILENT_DRIVE_THEME_H
...
public:
    ...
    QString configFileName() const  {
        return QLatin1String("silentdrive.cfg");
    }

    QIcon trayFolderIcon( const QString& ) const  {
        return themeIcon( QLatin1String("Silentdrive-icon") );
    }
    ...
    QString updateCheckUrl() const {
        return QLatin1String("https://silentinfotech.com");
    }

    QString helpUrl() const {
        return QString::fromLatin1("https://silentinfotech.com").arg(MIRALL_VERSION_MAJOR).arg(MIRALL_VERSION_MINOR);
    }
    ...
    QString about() const {
      ...
      //               "Olivier Goffart, Markus Götz and others.</small></p>");
        ...
        re += tr("<p>This release was supplied by the Silent Infotech<br />"
                 "Copyright 2017 Silent Infotech</p>");
